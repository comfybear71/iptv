...
export default function VodSeriesPage() {
  ...
  const url = buildFilteredSeriesUrl({
    host,
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">
            Filter by year and genre, then watch in browser or copy the M3U
            URL.
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-4">
        <Stat label="Total Episodes" value="44,998" icon="🎞️" />
        <Stat label="TV Series" value="2,963" icon="📺" />
        <Stat label="Avg Rating" value="7.3" icon="⭐" />
        <Stat
          label="Selected Size"
