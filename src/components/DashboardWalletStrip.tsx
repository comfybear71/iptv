...
function LinkWalletModal({
  ...
  // has backdrop-filter, which creates a stacking context that would
  // otherwise trap `fixed` positioning. Rendering via portal to
  // document.body escapes all parent stacking contexts.
  useEffect(() => {
    setMounted(true);
